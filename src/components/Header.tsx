...
export function Header() {
  ...
  return (
    <div className="sticky top-0 z-50 border-b border-blush/25 bg-maroon">
      <div className="relative flex items-center justify-between gap-6 overflow-hidden px-6 py-3 sm:px-10">
        ...
        <div className="relative flex items-center gap-3 sm:gap-5">
          ...
          <button
            ...
            className="flex h-9 w-9 flex-col items-center justify-center gap-[5px] rounded-full border border-cream/25 md:hidden"
          >
            <span
              className={
      ...
      {menuOpen && (
        <nav className="flex flex-col border-t border-blush/25 bg-maroon px-6 py-2 sm:px-10 md:hidden">
          {CUSTOMER_NAV.map((n) => (
            <Link
              key={n.href}
              href={`/${n.href}`}
